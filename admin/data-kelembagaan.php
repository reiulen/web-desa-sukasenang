                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a class="btn btn-primary text-white" href="tambah-kelembagaan.php">Tambah Halaman</a>
                        </div>
                        <div class="card-body">
                               <table id="dataTable" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                     <?php 
                                     include '../db.php';
                                            $kelembagaan = mysqli_query($conn, "SELECT * FROM tb_kelembagaan ORDER BY id_kelembagaan DESC");

                                            while ($row = mysqli_fetch_array($kelembagaan)) {
                                    ?>
                                <tr class="kolom">
                                    <td><img src="../web/gambar/<?php echo $row['gambar_halaman'] ?>"width = "100px"></td>
                                    <td><?php echo $row['nama_halaman'] ?></td>
                                    <td>
                                        <a href="proses-hapus.php?idk=<?php echo $row['id_kelembagaan'] ?>"  class="btn btn-primary btn-circle shadow" ><i class="fas fa-trash"></i></a>
                                        <a href="edit/edit-kelembagaan.php?id=<?php echo $row['id_kelembagaan'] ?>" class="btn btn-primary btn-circle shadow" ><i class="fas fa-edit"></i></a>
                                    </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
