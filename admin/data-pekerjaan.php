                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a class="btn btn-primary text-white" href="tambah-pekerjaan.php">Tambah Pekerjaan</a>
                        </div>
                        <div class="card-body">
                             <table id="dataTable" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                     <?php 
                                     include '../db.php';
                                            $artikel = mysqli_query($conn, "SELECT * FROM tb_pekerjaan ORDER BY id DESC");
                                ...
                                <tr class="kolom">
                                    ...
                                    <td>
                                        <a href="proses-hapus.php?idpe=<?php echo $row['id'] ?>" class="btn btn-primary btn-circle shadow" ><i class="fas fa-trash"></i></a>
                                        <a href="edit/edit-pekerjaan?id=<?php echo $row['id'] ?>"class="btn btn-primary btn-circle shadow" ><i class="fas fa-edit"></i></a>
                                    </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
