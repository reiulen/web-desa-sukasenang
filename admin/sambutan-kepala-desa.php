              ...
              <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="sambutan-kepala-desa?id=3.php">Sambutan Kepala Desa</a>
                    </div>
                </div>
            </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h3 class="text-dark">Sambutan Kepala Desa</h3>
                        </div>
                        <div class="card-body">
                           <div class="box">
                                <form action="" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                          <label class="form-label"><h5>Nama Kepala Desa</h5></label>
                          <input type="text" name="nama" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Judul Artikel" value="<?php echo $s -> nama ?>">
                        </div>
                          <div class="mb-3">
                          <label class="form-label"><h5>Foto Kepala Desa</h5> 
                            <img src="../web/gambar/<?php echo $s -> gambar ?>"width="25%">
                            <p><input type="hidden" name="foto" value="<?php echo $s -> gambar ?>" ></p>
                          </label>
                          <input type="file" name="foto" class="form-control" id="exampleInputPassword1">
                        </div>
                        <div class="mb-3">
                          <label class="form-label"><h5>Isi Sambutan</h5></label>
                          <textarea type="text" name="isi_sambutan" class="form-control" id="exampleInputPassword1" placeholder="Deskripsi"><?php echo $s -> sambutan ?></textarea>
                       </div>
                        <button type="submit" name="submit" class="btn btn-primary">Submit</button>
                            ...
                            <?php 
                              if(isset($_POST['submit'])){
                                  ...
                                  $update = mysqli_query($conn, "UPDATE tb_sambutan SET
                                  ...
                                  if($update){
                                              ...
                                              echo '<script>location="sambutan-kepala-desa.php"</script>';
                                            }else{
