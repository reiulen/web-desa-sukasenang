                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h3 class="text-dark">Tambah Artikel</h3>
                        </div>
                        <div class="card-body">
                           <div class="box">
                            <form action="" method="POST" enctype="multipart/form-data">
                             <div class="mb-3">
                                <label class="form-label"><h5>Diupload Oleh</h5></label>
                                <input type="text" name="oleh" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nama">
                            </div>
                            <div class="mb-3">
                                <label class="form-label"><h5>Judul Artikel</h5></label>
                                <input type="text" name="judul" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Judul Artikel">
                            </div>
                                <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label class="form-label"><h5>Isi Artikel</h5></label>
                                <textarea type="text" name="isi_artikel" class="form-control" id="exampleInputPassword1" placeholder="Deskripsi"></textarea>
                            </div>
