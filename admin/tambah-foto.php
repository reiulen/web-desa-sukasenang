                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h3 class="text-dark">Tambah Gambar</h3>
                        </div>
                        <div class="card-body">
                           <div class="box">
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label class="form-label"><h5>Nama Gambar</h5></label>
                                <input type="text" name="judul" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nama Gambar">
                            </div>
                             <div class="mb-3">
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                if (!in_array($type2, $tipe_diizinkan)) {
                                  ...
                                  $insert = mysqli_query($conn, " INSERT INTO gallery VALUES(
                                          null,
                                          '".$judul."',
                                          '".$deskripsi."',
                                          '".$newname."',
