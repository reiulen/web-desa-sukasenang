                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h3 class="text-dark">Tambah Perngkat</h3>
                        </div>
                        <div class="card-body">
                           <div class="box">
                            ...
                            <div class="mb-3">
                             ...
                             <div class="mb-3">
                                ...
                                <input type="text" name="jabatan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Jabtan">
                            </div>
                                <div class="mb-3">
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                if (!in_array($type2, $tipe_diizinkan)) {
                                  ...
                                  $insert = mysqli_query($conn, " INSERT INTO tb_perangkat VALUES(
                                          null,
                                          '".$nama."',
                                          '".$jabatan."',
                                          '".$newname."'   
