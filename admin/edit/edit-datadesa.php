...
session_start();
 ...
 include '../../db.php';
 $artikel = mysqli_query($conn, "SELECT * FROM tb_datadesa WHERE id_data ='".$_GET['id']."' ");
                        ...
                        <div class="card-body">
                          ...
                          <div class="mb-3">
                              ...
                              <div class="mb-3">
                                ...
                                <textarea type="text" name="isi_halaman" class="form-control" id="exampleInputPassword1" placeholder="Isi Halaman"><?php echo $a -> isi_halaman?></textarea>
                             </div>
