...
session_start();
 ...
 include '../../db.php';
 $artikel = mysqli_query($conn, "SELECT * FROM tb_kelembagaan WHERE id_kelembagaan ='".$_GET['id']."' ");
              ...
              <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                         <a class="collapse-item active" href="../data-halaman.php">Profil</a>
                        <a class="collapse-item active" href="../data-kelembagaan.php">Kelembagaan</a>
                        <a class="collapse-item active" href="../data-desa.php">Data Desa</a>
                ...
                <div class="container-fluid">
                   ...
                   <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h3 class="text-dark">Edit Halaman</h3>
                        </div>
                        <div class="card-body">
                           <div class="box">
                          ...
                          <div class="mb-3">
                                <label class="form-label"><h5>Nama Halaman</h5></label>
                                <input type="text" name="nama_halaman" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nama Halaman" value="<?php echo $a -> nama_halaman ?>">
                              </div>
                               <div class="mb-3">
                                <label class="form-label"><h5>Judul Halaman</h5></label>
                                <input type="text" name="judul" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Judul Halaman" value="<?php echo $a -> judul_halaman ?>">
                              </div>
                                <div class="mb-3">
                                <label class="form-label"><h5>Gambar</h5> 
                                  <img src="../../web/gambar/<?php echo $a -> gambar_halaman ?>"width="25%">
                                  <p><input type="hidden" name="gambar" value="<?php echo $a -> gambar_halaman ?>" ></p>
                                </label>
                                <input type="file" name="gambar" class="form-control" id="exampleInputPassword1">
                              </div>
                              <div class="mb-3">
                                <label class="form-label"><h5>Isi Halaman</h5></label>
                                <textarea type="text" name="isi_halaman" class="form-control" id="exampleInputPassword1" placeholder="Deskripsi"><?php echo $a -> isi_halaman?></textarea>
                             </div>
                            <button type="submit" name="submit" class="btn btn-primary">Submit</button>
                                  ...
                                  <?php 
                                        ...
                                        $update = mysqli_query($conn, "UPDATE tb_kelembagaan SET
                                                    nama_halaman='".$nama_halaman."',
                                                    judul_halaman='".$judul."',
                                                    gambar_halaman='".$namagambar."',
                                                    isi_halaman='".$isi_halaman."'
                                                    WHERE id_kelembagaan = '".$a->id_kelembagaan."'
                                                    ");
                                        if($update){
