<?php
 ...
 include '../../db.php'; $artikel = mysqli_query($conn, "SELECT * FROM tb_pekerjaan WHERE id ='".$_GET['id']."' ");
            ...
            <li class="nav-item">
              ...
              <li class="nav-item active">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                         <a class="collapse-item active" href="data-pekerjaan.php">Pekerjaan</a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h3 class="text-dark">Edit Pekerjaan</h3>
                        </div>
                        <div class="card-body">
                           <div class="box">
                          <form action="" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label class="form-label"><h5>Nama Pekerjaan</h5></label>
                                <input type="text" name="pekerjaan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nama Pekerjaan" value=" <?php echo $a -> pekerjaan ?>">
                            </div>
                            <div class="mb-3">
                         ...
                         <?php 
                            if(isset($_POST['submit'])){
                                ...
                                $jumlah        = $_POST['jumlah'];
                                   ...
                                   $update = mysqli_query($conn, "UPDATE tb_pekerjaan SET
                                                    pekerjaan= '".$pekerjaan."',
                                                    jumlah= '".$jumlah."'
                                                    WHERE id = '".$a->id."'
                                                    ");
