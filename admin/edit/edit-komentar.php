                ...
                <div class="container-fluid">
                   ...
                   <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h3 class="text-dark">Perizinan Komentar</h3>
                        </div>
                        <div class="card-body">
                           <div class="mb-3">
                                <h5>Nama :</h5>
                            ...
                            <form method="POST" action="">
                              <div class="mb-3">
                                <h5 class="form-label">Status Komentar :
                                    <select name="status">
                                    <option value="Aktif" selected>Aktif</option>
                                    <option value="NonAktif" selected>Nonaktif</option>
                                    <option value="<?= $a-> status ?>" selected><?= $a->status ?></option>
                                    </select>
                                    <button type="submit" name="submit" class="btn btn-primary p-1">Ubah</button>
                                    </h5>
                              </div>
                                    </form>
                                    <?php
                                    ...
                                    $update = mysqli_query($conn, "UPDATE komentar SET
                                                 status='".$status."'
                                                 WHERE id = '".$a->id."'
                                                ");
                                    if($update){
