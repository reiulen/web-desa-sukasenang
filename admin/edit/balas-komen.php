...
session_start();
 ...
 include '../../db.php';
 $artikel = mysqli_query($conn, "SELECT * FROM komentar WHERE id ='".$_GET['id']."' ");
                ...
                <div class="container-fluid">
                   ...
                   <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h3 class="text-dark">Balas Komentar</h3>
                        </div>
                        <div class="card-body">
                            <div class="mb-3">
                                <label class="form-label"><h5>Komentar :</h5></label>
                                <p><?= $a -> komentar ?></p>
                            </div>
                            <form action="" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="id_komen" value="<?= $a-> id ?>" >
                                <input type="hidden" name="id_berita" value="<?= $a  -> id_berita ?>">
                                <input type="hidden" name="nama_halaman" value="<?= $a  -> nama_halaman ?>">
                                <div class="mb-3">
                                    <label class="form-label"><h5>Balas</h5></label>
                                    <textarea type="text" name="balasan" class="form-control" id="exampleInputPassword1" placeholder="Balas"></textarea>
                                </div>           
                                <button type="submit" name="balas" class="btn btn-primary">Submit</button>
                                </div>
                             </form>
                             <?php
                                 if(isset($_POST['balas'])){
                                $komentar     = $_POST['balasan'];
