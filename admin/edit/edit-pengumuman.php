...
session_start();
 ...
 include '../../db.php';
$pengumuman = mysqli_query($conn, "SELECT * FROM tb_pengumuman WHERE id ='".$_GET['id']."' ");
$a = mysqli_fetch_object($pengumuman);
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h3 class="text-dark">Edit Pengmuman</h3>
                        </div>
                        <div class="card-body">
                           <div class="box">
                          <form action="" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label class="form-label"><h5>Nama Pengumuman</h5></label>
                                <input type="text" name="nama_pengumuman" class="form-control" id="exampleInputEmail1" value="<?php echo $a -> nama_pengumuman ?>" placeholder="Nama Pengumuman">
                            </div>
                            <div class="mb-3">
                                <label class="form-label"><h5>Lokasi</h5></label>
                                <input type="text" name="lokasi" class="form-control" value="<?php echo $a -> lokasi ?>" placeholder="Lokasi">
                            </div>
                            <div class="mb-3">
                                <label class="form-label"><h5>Dari</h5></label>
                                <input id="tanggal_awal" name="tanggal_awal" width="276" value="<?php echo $a -> tanggal_awal ?>">
                                 <script>
                           ...
                           <div class="mb-3">
                                <label class="form-label"><h5>Sampai</h5></label>
                                <input id="tanggal_akhir" name="tanggal_akhir" width="276" value="<?php echo $a -> tanggal_akhir ?>">
                                 <script>
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                $tangal_awal        = $_POST['tanggal_awal'];
                                $tangal_akhir  = $_POST['tanggal_akhir'];
                                $lokasi = $_POST['lokasi'];
                                
                                   $update = mysqli_query($conn, "UPDATE tb_pengumuman SET
                                                    tanggal_awal= '".$tangal_awal."',
                                                    tanggal_akhir= '".$tangal_akhir."',
