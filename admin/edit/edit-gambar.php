...
include '../../db.php';
 $artikel = mysqli_query($conn, "SELECT * FROM gallery WHERE id_gambar ='".$_GET['id']."' ");
                           ...
                           <div class="box">
                            <form action="" method="POST" enctype="multipart/form-data">
                             <div class="mb-3">
                                ...
                                <input type="text" name="nama" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nama" value="<?php echo $a -> judul ?>">
                              </div>
                              <div class="mb-3">
                                <label class="form-label"><h5>Deskripsi</h5></label>
                                <input type="text" name="deskripsi" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Deskripsi" value="<?php echo $a -> deskripsi ?>">
                              </div>
                               <div class="mb-3">
                                <label class="form-label"><h5>Link</h5></label>
                                <input type="text" name="link" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Link" value="<?php echo $a -> link ?>">
                              </div>
                             <div class="mb-3">
