...
session_start();
 ...
 include '../../db.php';
 $artikel = mysqli_query($conn, "SELECT * FROM tb_jkelamin WHERE id ='".$_GET['id']."' ");
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h3 class="text-dark">Edit Jenis Kelamin</h3>
                        </div>
                        <div class="card-body">
                           <div class="box">
                          <form action="" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label class="form-label"><h5>Jenis Kelamin</h5></label>
                                <input type="text" name="nama" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nama Pekerjaan" value=" <?php echo $a -> n_kelamin ?>">
                            </div>
                            <div class="mb-3">
                         ...
                         <?php 
                            if(isset($_POST['submit'])){
                                ...
                                $jumlah        = $_POST['jumlah'];
                                   ...
                                   $update = mysqli_query($conn, "UPDATE tb_jkelamin SET
                                                    n_kelamin= '".$nama."',
                                                    jumlah= '".$jumlah."'
                                                    WHERE id = '".$a->id."'
                                                    ");
