...
session_start();
 ...
 include '../../db.php';
 $artikel = mysqli_query($conn, "SELECT * FROM tb_sosmed WHERE id ='".$_GET['id']."' ");
                ...
                <div class="container-fluid">
                   ...
                   <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h3 class="text-dark">Edit Sosmed</h3>
                        </div>
                        <div class="card-body">
                           <div class="box">
                                <form action="" method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
                                <label class="form-label"><h5>Nama Sosmed</h5></label>
                                <input type="text" name="nama" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nama Sosmed" value="<?php echo $a -> nama ?>">
                              </div>
                              <div class="mb-3">
                                <label class="form-label"><h5>Link Sosmed</h5></label>
                                <textarea type="text" name="link" class="form-control" id="exampleInputPassword1" placeholder="Link sosmed"><?php echo $a -> link ?></textarea>
                             </div>
                             <div class="mb-3">
                                <label class="form-label"><h5>Logo Sosmed</h5> 
                                  <img src="../../web/gambar/<?php echo $a -> gambar ?>"width="25%">
                                  <p><input type="hidden" name="logo" value="<?php echo $a -> gambar ?>" ></p>
                                </label>
                              ...
                              <?php 
                                if(isset($_POST['submit'])){
                                   ...
                                   $foto        =$_POST['logo'];
                                    ...
                                    $update = mysqli_query($conn, "UPDATE tb_sosmed SET
                                                 nama='".$nama."',
                                                 link='".$link."',
                                                 gambar='".$namagambar."'
                                                 WHERE id = '".$a->id."'
