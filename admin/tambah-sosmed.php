       ...
       <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
           ...
           <li class="nav-item">
            ...
            <li class="nav-item active">
                <a class="nav-link active" href="data-sosmed.php">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h3 class="text-dark">Tambah Sosmed</h3>
                        </div>
                        <div class="card-body">
                           <div class="box">
                            ...
                            <div class="mb-3">
                             ...
                             <div class="mb-3">
                                ...
                                <input type="text" name="link" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Link Sosmed">
                            </div>
                                <div class="mb-3">
                                <label class="form-label"><h5>Logo Sosmed</h5></label>
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                if (!in_array($type2, $tipe_diizinkan)) {
                                  ...
                                  $insert = mysqli_query($conn, " INSERT INTO tb_sosmed VALUES(
                                          null,
                                          '".$nama."',
                                          '".$newname."',
                                          '".$link."'
