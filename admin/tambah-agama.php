                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h3 class="text-dark">Tambah Agama</h3>
                        </div>
                        <div class="card-body">
                           <div class="box">
                          <form action="" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Agama">
                            </div>
                            <div class="mb-3">
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                $jumlah  = $_POST['jumlah'];
                                  ...
                                  $insert = mysqli_query($conn, " INSERT INTO tb_agama VALUES(
                                          null,
                                          '".$nama."',
                                          '".$jumlah."'
                                )");
