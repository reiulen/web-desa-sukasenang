                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a class="btn btn-primary text-white" href="tambah-perangkat.php">Tambah Perangkat</a>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                     <?php 
                                     include '../db.php';
                                            $perangkat = mysqli_query($conn, "SELECT * FROM tb_perangkat ORDER BY id_perangkat DESC");

                                            while ($row = mysqli_fetch_array($perangkat)) {
                                    ?>
                                <tr class="kolom">
                                    <td><?php echo $row['nama'] ?></td>
                                    <td><?php echo $row['jabatan'] ?></td>
                                    <td><img src="../web/gambar/<?php echo $row['gambar'] ?>"width = "100px"></td>
                                    <td>
                                        <a href="proses-hapus.php?idh=<?php echo $row['id_perangkat'] ?>" class="btn btn-primary btn-circle shadow" ><i class="fas fa-trash"></i></a>
                                        <a href="edit/edit-perangkat.php?id=<?php echo $row['id_perangkat'] ?>"class="btn btn-primary btn-circle shadow" ><i class="fas fa-edit"></i></a>
                                    </td>
                                    </tr>
                                    <?php } ?>
