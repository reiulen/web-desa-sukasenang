                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h3 class="text-dark">Tambah Halaman</h3>
                        </div>
                        <div class="card-body">
                           <div class="box">
                          <form action="" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_halaman" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nama Halaman">
                            </div>
                             <div class="mb-3">
                                <label class="form-label"><h5>Judul Halaman</h5></label>
                                <input type="text" name="judul" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Judul Halaman">
                            </div>
                                <div class="mb-3">
                                <label class="form-label"><h5>Gambar</h5></label>
                                <input type="file" name="gambar" class="form-control" id="exampleInputPassword1">
                            </div>
                            <div class="mb-3">
                                <label class="form-label"><h5>Isi Halaman</h5></label>
                                <textarea type="text" name="isi_halaman" class="form-control" id="exampleInputPassword1" placeholder="Isi Halmaan"></textarea>
                            </div>
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                if (!in_array($type2, $tipe_diizinkan)) {
                                  ...
                                  $insert = mysqli_query($conn, " INSERT INTO tb_kelembagaan VALUES(
                                          null,
                                          '".$nama_halaman."',
                                          '".$judul."',
                                          '".$newname."',
