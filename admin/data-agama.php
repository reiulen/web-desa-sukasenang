                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a class="btn btn-primary text-white" href="tambah-agama.php">Tambah Agama</a>
                        </div>
                        <div class="card-body">
                            <div class="card-body">
                               <table id="dataTable" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                     <?php 
                                     include '../db.php';
                                            $artikel = mysqli_query($conn, "SELECT * FROM tb_agama ORDER BY id DESC");
                                ...
                                <tr class="kolom">
                                    ...
                                    <td>
                                        <a class="btn btn-primary btn-circle shadow" href="proses-hapus.php?idag=<?php echo $row['id'] ?>"><i class="fas fa-trash"></i> </a>
                                        <a href="edit/edit-agama?id=<?php echo $row['id'] ?>" class="btn btn-primary btn-circle shadow">
