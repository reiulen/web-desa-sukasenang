                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a class="btn btn-primary text-white" href="tambah-tempat.php">Tambah Tempat</a>
                        </div>
                        <div class="card-body">
                            <table id="dataTable" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                     <?php 
                                     include '../db.php';
                                            $artikel = mysqli_query($conn, "SELECT * FROM map ORDER BY id DESC");

                                            while ($row = mysqli_fetch_array($artikel)) {
                                    ?>
                                <tr class="kolom">
                                    <td><?php echo $row['n_tempat'] ?></td>
                                    <td><img src="../web/gambar/<?php echo $row['gambar_tempat'] ?>" class="img-fluid" style="width: 200px;"></td>
                                    <td><?php echo $row['lat'] ?></td>
                                    <td><?php echo $row['lng'] ?></td>
                                     <td><img src="../web/gambar/<?php echo $row['marker'] ?>" class="img-fluid mx-auto" style="width: 50px;"></td>
                                    <td>
                                        <a href="proses-hapus.php?idtm=<?php echo $row['id'] ?>" class="btn btn-primary btn-circle shadow"><i class="fas fa-trash"></i></a>
                                        <a href="edit/edit-tempat?id=<?php echo $row['id'] ?>" class="btn btn-primary btn-circle shadow"><i class="fas fa-edit"></i></a>
                                    </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
