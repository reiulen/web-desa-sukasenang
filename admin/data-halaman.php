                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a class="btn btn-primary text-white" href="tambah-halaman.php">Tambah Halaman</a>
                        </div>
                        <div class="card-body">
                             <table id="dataTable" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tr class="kolom">
                                    ...
                                    <td>
                                        <a href="proses-hapus.php?idp=<?php echo $row['id_profile'] ?>" class="btn btn-primary btn-circle shadow" ><i class="fas fa-trash"></i></a>
                                        <a href="edit/edit.php?id=<?php echo $row['id_profile'] ?>"class="btn btn-primary btn-circle shadow" ><i class="fas fa-edit"></i></a>
                                    </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
