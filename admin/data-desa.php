                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a class="btn btn-primary text-white" href="tambah-data-desa.php">Tambah Halaman</a>
                        </div>
                        <div class="card-body">
                                ...
                                <?php 
                                     include '../db.php';
                                            $kelembagaan = mysqli_query($conn, "SELECT * FROM tb_datadesa ORDER BY id_data DESC");
                                ...
                                <tr class="kolom">
                                    ...
                                    <td>
                                        <a class="btn btn-primary btn-circle shadow"  href="proses-hapus.php?idd=<?php echo $row['id_data'] ?>"><i class="fas fa-trash"></i> </a>
                                        <a class="btn btn-primary btn-circle shadow"  href="edit/edit-datadesa.php?id=<?php echo $row['id_data'] ?>"><i class="fas fa-edit"></i></a>
                                    </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
