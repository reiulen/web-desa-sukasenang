                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h3 class="text-dark">Tambah Pengmuman</h3>
                        </div>
                        <div class="card-body">
                           <div class="box">
                          <form action="" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_pengumuman" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nama Pengumuman">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="tanggal_awal" name="tanggal_awal" width="276" />
                                 <script>
                           ...
                           <div class="mb-3">
                                ...
                                <input id="tanggal_akhir" name="tanggal_akhir" width="276" />
                                 <script>
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                $lokasi = $_POST['lokasi'];
                                  ...
                                  $insert = mysqli_query($conn, " INSERT INTO tb_pengumuman VALUES(
                                          null,
                                          '".$tangal_awal."',
                                          '".$tangal_akhir."',
                                          '".$nama_pengumuman."',
