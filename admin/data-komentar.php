                        ...
                        <div class="card-body">
                             <table id="dataTable" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                     <?php 
                                     include '../db.php';
                                     $artikel = mysqli_query($conn, "SELECT * FROM komentar ORDER BY id DESC");
                                    ...
                                    <td>
                                        <a href="proses-hapus.php?idkom=<?php echo $row['id'] ?>"  class="btn btn-primary btn-circle shadow" ><i class="fas fa-trash"></i></a>
                                        <a href="edit/edit-komentar?id=<?php echo $row['id'] ?>" class="btn btn-primary btn-circle shadow" ><i class="fas fa-edit"></i></a>
                                        <a href="edit/balas-komen?id=<?php echo $row['id'] ?>" class="btn btn-primary m-2 shadow">Balas</a>
                                    </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
