...
session_start();
 if (!isset($_SESSION["login"])) {
     echo'<script>location="login-admin"</script>';
 }
                       ...
                       <li class="nav-item dropdown no-arrow mx-1">
                        ...
                        <li class="nav-item dropdown no-arrow show">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in show" aria-labelledby="userDropdown">
                               <a class="dropdown-item" href="ubahpw">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                    <h5 class="text-muted">Statistik Pengunjung<h5>
                                    <?php
                                    include'../db.php';
                                    $tanggal  = mysqli_query($conn, "SELECT * FROM tb_statistik GROUP BY tanggal DESC LIMIt 8");
                                    $hits  = mysqli_query($conn, "SELECT SUM(hits) AS jumlah_total FROM tb_statistik GROUP BY tanggal ");
                                     ?>
                                    ...
                                    <div class="chartarea">
                                      ...
                                      var data = {
                                                ...
                                                datasets: [
                                                {
                                                  ...
                                                  data: [<?php while ($p = mysqli_fetch_array($hits)) { echo '"' . $p['jumlah_total'] . '",';}?>],
                                                  backgroundColor: [
                                                    '#FFD100',
                                                    '#6A05FD',
                                                    '#FC2C2C',
