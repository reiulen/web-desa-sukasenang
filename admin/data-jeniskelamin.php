              ...
              <li class="nav-item active">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="data-jeniskelamin.php">Jenis Kelamin</a>
                    </div>
                </div>
            </li>
             <li class="nav-item ">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a class="btn btn-primary text-white" href="tambah-jeniskelamin.php">Tambah Jenis Kelamin</a>
                        </div>
                        <div class="card-body">
                            <table id="dataTable" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                     <?php 
                                     include '../db.php';
                                            $artikel = mysqli_query($conn, "SELECT * FROM tb_jkelamin ORDER BY id DESC");

                                            while ($row = mysqli_fetch_array($artikel)) {
                                    ?>
                                <tr class="kolom">
                                    <td><?php echo $row['n_kelamin'] ?></td>
                                    <td><?php echo $row['jumlah'] ?></td>
                                    <td>
                                        <a href="proses-hapus.php?idkl=<?php echo $row['id'] ?>"  class="btn btn-primary btn-circle shadow" ><i class="fas fa-trash"></i></a>
                                        <a href="edit/edit-jeniskelamin?id=<?php echo $row['id'] ?>" class="btn btn-primary btn-circle shadow" ><i class="fas fa-edit"></i></a>
                                    </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
