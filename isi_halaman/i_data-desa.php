...
include'../db.php';
     ...
     $berita = mysqli_query($conn, "SELECT * FROM tb_datadesa WHERE judul_halaman ='$title' ");
...
<section>
  <div class="banner-halaman" style="background-image: url(../asset/gambar/wave.svg); height:47vh; background-size: cover; ">
    ...
    <h1 style="font-weight:bold;">Data Desa</h1>
     <nav >
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="../." class="text-decoration-none" style="color:#dadada;"><i class="fa fa-home"></i></a></li>
        <li class="breadcrumb-item" aria-current="page"><a href="../datadesa" class="text-decoration-none" style="color:#dadada;">Data Desa</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-9 mx-auto">
         <?php 
          ...
          $url = $_GET['slug'];
          $title = str_replace("-", " ", $_GET['slug']);
          $artikel = mysqli_query($conn, "SELECT * FROM tb_datadesa WHERE judul_halaman ='$title' ");
          ...
          <div class="row content-artikel p-2">
            ...
            <p class="isi-artikel" align="justify" ><?php echo $a -> isi_halaman;?></p>
          </div>
        </div>
