    ...
    $berita = mysqli_query($conn, "SELECT * FROM tb_profile WHERE judul_halaman ='$title' ");
  ...
  <div class="banner-halaman" style="background-image: url(../asset/gambar/wave.svg); height:47vh; background-size: cover; ">
    ...
    <h1 style="font-weight:bold;">Profil</h1>
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" aria-current="page"><a href="../profil" class="text-decoration-none" style="color:#dadada;">Profil</a></li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-9 mx-auto">
         ...
         $url = $_GET['slug'];
          $title = str_replace("-", " ", $_GET['slug']);
          $artikel = mysqli_query($conn, "SELECT * FROM tb_profile WHERE judul_halaman ='$title' ");
